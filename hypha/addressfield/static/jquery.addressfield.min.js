...
(function () {
    ...
    addressfield.updateLabel = function (el, label) {
        var labelEl = labelFor(el) || el.previousElementSibling;
    ...
    addressfield.validate = function (el, field, config) {
        ...
        if (config.required) {
            ...
            if (label) {
                var req = label.querySelector(".form__required");
                if (req) req.remove();
            }
        }
    };

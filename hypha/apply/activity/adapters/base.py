...
neat_related = {
    ...
    MESSAGES.UPDATE_PROJECT_TITLE: "old_title",
    ...
    def process_send(
        ...
        **kwargs,
        ...
        for recipient in recipients:
            ...
            # If an extension has determined that a message shouldn't get sent,
            # then it shouldn't get sent to debug either.
            if hook_message["should_send"] and not settings.SEND_MESSAGES:
                if recipient:

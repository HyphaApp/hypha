...
class MESSAGES(TextChoices):
    ...
    CREATE_DISBURSEMENT = "CREATE_DISBURSEMENT", _("created disbursement")
    UPDATE_DISBURSEMENT = "UPDATE_DISBURSEMENT", _("updated disbursement")
    DELETE_DISBURSEMENT = "DELETE_DISBURSEMENT", _("deleted disbursement")

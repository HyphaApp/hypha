# Generated by Django 3.2.15 on 2022-08-31 11:31
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='RoundBaseProjectApprovalForm',
            fields=[
                ...
                ('round', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='approval_forms', to='funds.roundbase')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,

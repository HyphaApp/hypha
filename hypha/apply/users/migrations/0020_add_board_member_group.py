...
from hypha.apply.users.groups import BOARD_MEMBER_GROUP_NAME, GROUPS
...
def remove_groups(apps, schema_editor):
    Group = apps.get_model('auth.Group')
    Group.objects.filter(name=BOARD_MEMBER_GROUP_NAME).delete()


class Migration(migrations.Migration):

    dependencies = [
        ('users', '0019_merge_20211105_1718'),
    ]

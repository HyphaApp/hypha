...
ZULIP_DESTINATION_URL = env.get('ZULIP_DESTINATION_URL', None)
ZULIP_DESTINATION_STREAM = env.get('ZULIP_DESTINATION_STREAM', None)
ZULIP_DESTINATION_TOPIC = env.get('ZULIP_DESTINATION_TOPIC', None)
ZULIP_BOT_EMAIL = env.get('ZULIP_BOT_EMAIL', None)
ZULIP_API_KEY = env.get('ZULIP_API_KEY', None)

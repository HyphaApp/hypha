...
export class ScreeningStatusContainer extends React.PureComponent {
  ...
  componentDidUpdate(prevProps) {
    ...
    if(submissionID != prevProps.submissionID && !submissionScreening.length) this.props.showLoading()
    ...
    if(submissionScreening.length && prevProps.submissionScreening !== submissionScreening) {
      this.props.setVisibleSelected(submissionScreening[0].selectedReasons)
      this.props.setDefaultSelected(submissionScreening[1].selectedDefault)

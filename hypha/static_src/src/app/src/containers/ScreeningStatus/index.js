          ...
          <div className="screening-default-options" >
            <div 
              className={screeningInfo.selectedValues.length ||
                screeningInfo.defaultSelectedValue && screeningInfo.defaultSelectedValue.id == defaultOptions.yes.id ? 
            ...
            <div 
              className={screeningInfo.selectedValues.length || 
                screeningInfo.defaultSelectedValue && screeningInfo.defaultSelectedValue.id == defaultOptions.no.id ? 

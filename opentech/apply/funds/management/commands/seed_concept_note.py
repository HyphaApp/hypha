...
class Command(BaseCommand):
    ...
    def create_concept_note_form(self):
        ...
        data = [
            ...
            {"type": "title", "value": {"field_label": "What is your project name?", "help_text": "", "info": null}, "id": "fd8e6437-89a4-4515-84d0-15c31be716ea"},
            {"type": "full_name", "value": {"field_label": "Your name", "help_text": "", "info": null}, "id": "825f74bf-9419-411a-97d1-631346ae7218"},
            {"type": "email", "value": {"field_label": "E-mail", "help_text": "", "info": null}, "id": "d66e3f38-48db-498a-83a5-4781ded03941"},
            {"type": "address", "value": {"field_label": "Address", "help_text": "", "info": null}, "id": "ea070127-684c-4136-8489-63c352b409c9"},
            ...
            {"type": "value", "value": {"field_label": "How much do you want?", "help_text": "", "info": null}, "id": "1e669b4d-e43f-4c7a-9730-08e25cb1592d"},
            ...
            {"type": "checkbox", "value": {"field_label": "My application will be dismissed if it does not fit within OTF\'s mission, values, principles statements.", "help_text": "", "default_value": false}, "id": "4c661a64-2614-4169-b4d2-1fd39e2e831b"},
            ...
            {"type": "checkbox", "value": {"field_label": "I have read and understand OTF\'s Terms and Privacy policy.", "help_text": "", "default_value": false}, "id": "1bc4e113-1414-46ff-bba7-2dc02b2126df"},
            {"type": "text_markup", "value": "Read the <a href=\"\/tos\">Terms and Privacy policy</a>.", "id": "d1c79c07-02cb-4f59-b5ed-719da7bdd636"},
            {"type": "checkbox", "value": {"field_label": "I am legally able to sign contracts or represent an organization that can.", "help_text": "", "default_value": false}, "id": "42dd68a1-b699-4678-bea6-13e0f842e821"},
            {"type": "checkbox", "value": {"field_label": "I understand that all intellectual property created with support for this application must be openly licensed.", "help_text": "", "default_value": false}, "id": "72916731-ec97-4688-95f1-d3bf140b03c2"},
            {"type": "checkbox", "value": {"field_label": "I understand that if my application is incomplete in any way, it will be dismissed.", "help_text": "", "default_value": false}, "id": "6856d26d-b169-4fdf-b598-63c3dd9278a2"},
            {"type": "checkbox", "value": {"field_label": "I understand that if my application is after a deadline, it will not be reviewed until after the next deadline.", "help_text": "", "default_value": false}, "id": "33838399-f292-4b63-83f0-e02d344f99d4"},
            {"type": "text_markup", "value": "<h3>I would like to</h3>", "id": "3ff08317-92ab-4eb1-adca-08547bed96f8"},
            {"type": "checkbox", "value": {"field_label": "Sign up to the OTF-Announce list, low traffic (funding opportunities, major alerts, etc).", "help_text": "", "default_value": false}, "id": "fc571e12-d4a2-4d53-ab34-2c57321dc6ac"},
            {"type": "checkbox", "value": {"field_label": "Sign up for OTF\'s daily newsletter (collection of news related to global internet freedom).", "help_text": "", "default_value": false}, "id": "cd0d8a4b-e71a-4dff-964a-f547bd655e7d"}
        ]

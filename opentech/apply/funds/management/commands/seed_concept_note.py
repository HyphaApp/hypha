...
class Command(BaseCommand):
    ...
    def create_concept_note_form(self):
        ...
        data = [
            ...
            {"type": "dropdown", "value": {"field_label": "How long will it take?", "help_text": "", "required": "", "choices": ["1 month", "2 month", "3 month", "4 month", "5 month", "6 month", "7 month", "8 month", "9 month", "10 month", "11 month", "12 month", "18 month", "24 month"]}, "id": "a3fa1b0b-3e8e-4335-8c09-d1403668f01b"},
    ...
    def create_proposal_form(self):
        ...
        data2 = [
            ...
            {"type": "char", "value": {"field_label": "Commonly used name", "help_text": "", "required": "", "format": "", "default_value": ""}, "id": "d5cd3d89-89ea-44c2-9772-0da658c36881"},
            ...
            {"type": "category", "value": {"field_label": "", "help_text": "", "required": "", "category": countries_id, "multi": "true"}, "id": "4b79c527-bf24-47f1-87a7-39945e70caeb"},

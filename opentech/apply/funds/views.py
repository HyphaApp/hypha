...
@method_decorator(staff_required, name='dispatch')
class SubmissionStaffFlaggedView(AllActivityContextMixin, BaseAdminSubmissionsTable):
...
@method_decorator(staff_required, name='dispatch')
class SubmissionUserFlaggedView(AllActivityContextMixin, BaseAdminSubmissionsTable):

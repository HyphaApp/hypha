...
DoubleStageDefinition = [
    {
        INITIAL_STATE: {
            'transitions': {
                ...
                'concept_determination': {'display': 'Ready For Determination', 'permissions': {UserPermissions.ADMIN, UserPermissions.LEAD}},
            },
            'display': 'Screening',
    ...
    },
    {
        'draft_proposal': {
            'transitions': {
                ...
                'proposal_determination': {'display': 'Ready For Determination', 'permissions': {UserPermissions.ADMIN, UserPermissions.LEAD}},
            },

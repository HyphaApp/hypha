...
class ReportEditForm(forms.ModelForm):
    public_content = RichTextField(
        help_text="This section of the report will be shared with the broader OTF community."
    )
    private_content = RichTextField(
        help_text="This section of the report will be shared with OTF staff only."
    )
